...
export const aboutData = [
  {
    ...
    content:
      '빠른 프로토타이핑을 통해 PMF를 확보하고, 1년만에 2개의 프로덕트를 성공적으로 런칭, 운영해본 경험이 있습니다. 데이터 기반의 애자일한 실험 방식에도 익숙하며, 주도적으로 참여하여 새로운 피처를 논의하고, UX적인 개선점 찾기를 즐깁니다. 필요할 경우 3D, NFC, 시리얼 통신 등 도메인을 가리지 않는 다양한 기능 개발을 통해 엔지니어링적 문제를 해결합니다.',
  },
  {
    title: '무엇이 필요한지를 압니다',
    subtitle:
  ...
  },
  {
    ...
    content:
      '가끔 토이프로젝트 만들어 공유하는 것을 좋아합니다. 슬랙봇 부터 사내 명함을 3D로 구현한 프로젝트, 회식 장소를 정하기 위한 월드컵 사이트 등, 사소하지만 재미있는 아이디어를 직접 구현하기를 즐깁니다. 동시에 토이 프로젝트를 통해 새로운 UI 혹은 프레임워크 등, 평소 관심있던 새로운 기술을 시도해보기도 하여 그 기술을 실제 손 끝으로 느껴보고자 노력합니다.',
  },
];
...
export const skillsData: SkillItemType[] = [
  ...
  },
  {
    ...
    description:
      'Nextjs 프로젝트의 배포를 위해 사용했습니다. github actions 파이프라인으로 CD를 구축했습니다.',
  },
];
...
export const projectsData: ProjectItemType[] = [
  {
    ...
    details: [
      ...
      {
        content:
          '웹과 앱의 컨벤션을 통일하기 위해 내부 유틸을 개발하여 컴포넌트 스타일링을 템플릿화했습니다. 이는 작업 속도를 크게 향상시켜, 기존 두 명이 수행하던 작업을 혼자서도 가능하게 만들었습니다.',
        type: 'text',
      },
      {
        content:
          '번들링시 트리셰이킹이 가능하도록 export단계 개선작업을 진행하여 모듈 크기를 줄일 수 있었습니다. ',
        type: 'text',
      },
      { content: '지속적인 서비스 개선에 관심을 두고 작업했습니다', type: 'subtitle' },
      {
        content:
          '안드로이드 플랫폼에서 마이페이지의 게시글이 많아지며 infinite scroll에서 성능 문제가 발생했고, lazy load와 virtualizer 적용을 통해 블로킹 타임을 최대 4초 가량 개선시켰습니다.',
        type: 'text',
      },
      {
        content:
          '채팅 서비스에서 설계가 잘못되어 상태, 역할별 20개가 넘는 중복 컴포넌트가 존재했고, 이를 다이어그램을 통해 정리하여 6개의 공통 로직으로 묶어냈습니다. 이를 통해 유지보수성을 향상시켰습니다.',
        type: 'text',
      },
      {
        content:
          '광고 서비스 성과 측정이 불확실한 문제 해결을 위해 이미지를 base64로 캐싱하여 로드 우선 순위를 주었고, onLoad 핸들러를 주어 더 정확한 성과 측정을 가능하도록 만들었습니다.',
        type: 'text',
      },
      { content: '스쿼드 단위의 협업을 경험했습니다', type: 'subtitle' },
      {
        content:
          '스쿼드 단위로 3주 스프린트 작업을 진행했으며, 이벤트 데이터에 기반한 유저 실험을 구현했습니다.',
        type: 'text',
      },
      {
        content: 'Jira, 컨플루언스를 비롯한 다양한 Saas를 적극 활용해 태스크 관리, 협업을 했습니다',
        type: 'text',
      },
      {
    ...
    image: '/images/projects/careerly.png',
  ...
  },
  {
    ...
    details: [
      ...
      {
        content:
          '적은 인원간의 빠른 개발을 위해 NX 모노레포로 함께 구성된 Node 기반 백엔드와 TypeScript를 활용하여 인터페이스를 공유하고 타이핑을 진행했습니다.',
        type: 'text',
      },
      {
        content:
      ...
      {
        content:
          'Serial API를 활용하여 브라우저 위에서도 프린터 등의 하드웨어가 제어가능하도록 기능을 개발했습니다.',
        type: 'text',
      },
      { content: '비즈니스적 실험에 적극 참여했습니다.', type: 'subtitle' },
      {
        content:
          '메뉴 및 주문 관리를 위한 대시보드를 개발했으며, 컴퓨터에 익숙치 못한 유저(사장님)들이 사용하기 편하도록 다양한 UX적 실험을 진행했습니다. 직관성을 위한 UI 개선과 드래그 앤 드롭 도입, 포스기를 고려한 터치 인터페이스 등, 피드백을 직접 받아 주도적으로 개선했습니다.',
        type: 'text',
      },
      {
        content:
    ...
    image: '/images/projects/taghere.png',
  ...
  },
  {
    ...
    details: [
      ...
      {
        content:
          'NextJS의 SSR환경 배포를 위해 EC2와 Vercel에 테스트를 진행하기도 했으며, Github Action을 이용하여 CD 파이프라인을 구축하였습니다.',
        type: 'text',
      },
      {
        content:
      ...
      {
        content:
          'Material UI를 커스터마이징하여 디자인시스템으로 사용했고, 주요 라이브러리를 npm에 배포하여 사용했습니다.',
        type: 'text',
      },
    ],
    image: '/images/projects/tmr-founders.png',
  ...
  },
  {
    ...
    image: '/images/projects/zcl-admin-dashboard.png',
  ...
  },
  {
    ...
    image: '/images/projects/tradeforce.png',
  ...
  },
  {
    ...
    details: [
      ...
      {
        content:
          'request 갯수에 상한선을 두어, 동기/비동기 요청을 별개로 주도록 만들어 서버 부하를 방지시켰습니다.',
        type: 'text',
      },
      {
      ...
      {
        content:
          '간단한 ipc통신으로 로컬 api를 구현했고, AbortController를 활용하여 요청 취소를 구현했습니다.',
        type: 'text',
      },
    ],
    image: '/images/projects/recruit-crawler.png',
    skills: [
      'ReactJS',
      'Electron',
      'TypeScript',
  ...
  },
  {
    ...
    image: '/images/projects/3d-virtual-store.png',
  ...
  },
  {
    ...
    image: '/images/projects/worship-team-live.png',
  ...
  //     ],
  //     image: '/images/projects/plog-in.png',
  ...
  //     ],
  //     image: '/images/projects/buckey.png',
  ...
  //     ],
  //     image: '/images/projects/jongang-counter.png',
  ...
  //     ],
  //     image: '/images/projects/entertainment-recommend.png',
  //     skills: ['ReactJS', 'JavaScript', 'Firebase'],
  ...
  //     ],
  //     image: '/images/projects/cheongnam.png',

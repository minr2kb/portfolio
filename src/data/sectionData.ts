...
export const projects: ProjectItemType[] = [
  {
    ...
    details: [
      `지표 중심 조직에서 스프린트 단위로 솔루션 회의에 참석했으며, 애널리틱스에 기반한 유저 실험을 구현했습니다.`,
      `디자인 시스템을 제작했습니다. 피그마 파이프라인 구성과 디자인 토큰 작업, 내부 스크립트 및 컴포넌트 작업을 진행했습니다.`,
  ...
  },
  {
    ...
    details: [
      ...
      '테이블과 포스기간의 실시간 통신을 위하여 소켓 통신을 사용했으며, 웹에서의 안정적인 작동을 위해 다양한 브라우져 환경에서의 트러블슈팅을 경험했습니다.',
      'NFC보안을 위하여 위치 검증 및 상태 관리를 통한 접근 제어 방식을 고안하였습니다.',
      '유저들을 직접 인터뷰까지 하며 빠른 피드백을 얻었고, 실시간 핫픽스를 통해 서비스를 점진적으로 개선시켰습니다.',
